...
<div class="row">
    <div class="col-md-12 col-sm-12">
        <div class="x_panel" style="border-radius: 8px">
            <div class="x_title">
                <h2>Form Edit Data Call</h2>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <form id="formEditCall" method="POST" action="<?php echo site_url('call/saveData'); ?>" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <div class="row">
                                <div class="col-md-2 col-sm-2 ">
                                    <input type="text" id="call_ke" name="call_ke" class="form-control" style="border-radius: 6px" data-error=".errorTxt13" value="<?php echo $data->attempt; ?>" readonly>
                                </div>
                                <label class="col-form-label col-md-1 col-sm-1 label-align" for="datecall" >Date</label>
                                <div class="col-md-4 col-sm-4">
                                    <input type="text" id="datecall" name="datecall" class="datepicker form-control" style="border-radius: 6px" data-error=".errorTxt13" placeholder="dd/mm/yyyy" value="<?php echo date('d/m/Y',strtotime($data->issued_date));?>">
                                </div>
                                <label class="col-form-label col-md-1 col-sm-1 label-align" for="timecall">Time</label>
                                <div class="col-md-4 col-sm-4">
                                    <input type="text" id="timecall" name="timecall" class="timepicker form-control" style="border-radius: 6px" data-error=".errorTxt13" placeholder="HH:mm" value="<?php echo date('H:i',strtotime($data->issued_time));?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 col-sm-6 ">
                    ...
                    <div class="item form-group">
                        <div class="col-md-6 col-sm-6 offset-md-3">
                            <a class="btn btn-secondary btn-sm" type="button" href="<?php echo site_url('call'); ?>" value="Cancel" id="btnCancel" form="formEditCall">Cancel</a>
                            <button class="btn btn-primary btn-sm" type="submit" name="save" value="save" id="btnSaveLead" form="formEditCall">Save</button>
                            <button class="btn btn-success btn-sm" type="submit" name="submit" value="submit" form="formEditCall">Submit</button>
                        </div>
                    </div>
                </form>
            </div>
