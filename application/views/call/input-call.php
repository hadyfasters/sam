...
<div class="row">
    <div class="col-md-12 col-sm-12">
        <div class="x_panel" style="border-radius: 8px">
            ...
            <div class="x_content">
                <form id="formInputCall" method="POST" action="<?php echo site_url('call/saveData'); ?>" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                    ...
                    <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="namaprospect">Nama Prospek</label>
                        <div class="col-md-6 col-sm-6 ">
                            <select style="border-radius: 6px; color: #495057;" id="namaprospect" name="namaprospect" class="form-control" placeholder="Nama Prospek" data-error=".errorTxt2" >
                                <option value="">Nama Prospek</option>
                            </select>
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <div class="row">
                                <div class="col-md-2 col-sm-2 ">
                                    <input type="text" id="call_ke" name="call_ke" class="form-control" style="border-radius: 6px" data-error=".errorTxt13" readonly>
                                </div>
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="input-group">
                                <div>
                                    ...
                                    <!-- <input type="file" class="custom-file-input" id="attach" name="attachment">
                    ...
                    <div class="item form-group">
                        <div class="col-md-6 col-sm-6 offset-md-3">
                            <a class="btn btn-secondary btn-sm" type="button" href="<?php echo site_url('call'); ?>" value="Cancel" id="btnCancel" form="formInputCall">Cancel</a>
                            <button class="btn btn-primary btn-sm" type="submit" name="save" value="save" id="btnSaveLead" form="formInputCall">Save</button>
                            <button class="btn btn-success btn-sm" type="submit" name="submit" value="submit" form="formInputCall">Submit</button>
                        </div>
                    </div>
                </form>
            </div>
