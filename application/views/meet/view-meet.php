            ...
            <div class="x_content">
                <table class="table table-bordered table-responsive-sm">
                    <tbody>
                        ...
                        <tr>
                            <td class="text-right font-weight-bold" style="width: 30%">Meet ke-</td>
                            <td>
                ...
                <form id="formApproveMeet" method="POST" action="<?php echo site_url('meet/approval'); ?>" data-parsley-validate class="form-horizontal form-label-left">
                    <input type="hidden" name="id" value="<?php echo $id; ?>">
                    <div class="item form-group">
                        <div class="col-md-12 col-sm-12 text-right">
                            <input class="btn btn-primary btn-sm" type="submit" name="reject" value="Reject" id="btnRejectMeet" form="formApproveMeet" onclick="return confirm('Apakah Anda Yakin?')" />
                            <input class="btn btn-success btn-sm" type="submit" name="approve" value="Approve" form="formApproveMeet" onclick="return confirm('Apakah Anda Yakin?')" />
                        </div>
                    </div>
                </form>
                <?php else : ?>
