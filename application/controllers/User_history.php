...
class User_history extends SAM_Controller {
	...
	{
        $users = $this->client_url->postCURL(USERHISTORY_LIST,'',$this->data['userdata']['token']); 
        ...
        $this->data['content'] = 'audit_trail/list-user-history';
        ...
        $this->data['javascriptLoad'] = array(
            ...
            12 => 'assets/build/js/userhistory.js'
        );
